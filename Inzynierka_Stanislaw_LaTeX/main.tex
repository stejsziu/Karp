...
\keywords bezzałogowy pojazd podwodny, ROV, AUV, ROS 2, Gazebo, model 6-DOF, sterowanie nieliniowe, fuzja sensoryczna, Pixhawk
...
\secondkeywords unmanned underwater vehicle, ROV, AUV, ROS 2, Gazebo, 6-DOF model, nonlinear control, sensor fusion, Pixhawk
